...
Второе тестовое задание компании EORA. В ходе решения использовались библиотеки: `pandas`, `numpy`, `scipy`.  Первое задание доступно по [ссылке](https://github.com/XanderMoroz/EORA_APIBot).
